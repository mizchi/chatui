...
export function Layout({ main, sidebar, tools, dialogOpened, editorTools, isEditorOpen }: LayoutProps) {
  // stop window scroll
  return (
    <div className="flex flex-col h-screen bg-gray-800">
      <div className="flex-1 overflow-y-auto">{main}</div>
      {isEditorOpen && <div className="flex-1 overflow-y-auto">{sidebar}</div>}
